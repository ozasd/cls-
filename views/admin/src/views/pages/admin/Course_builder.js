                    ...
                    <div className="row h-100 justify-content-center align-content-center bg-secondary2">
                        <div className="col-md-9 rounded-3 h-75 shadow border-top border-primary border-5 ">
                            <div className='row h-25 border-bottom align-content-center'>
                                ...
                                {/* <p className="text-center fs-4 fw-bold">{weekDay != undefined && (
                            <>
...
{console.log(next_course)}
                    <div className="row h-100">
                        <div className="col-md-12">
                            <div className="row shadow justify-content-center mb-3">
                                <div className="col-md-11 p-1">
                                    <h1 className="fs-1  fw-bold text-center text-green">{weekDay[0][0].split('-')[1] + ' / ' + weekDay[0][0].split('-')[2]} ~ {weekDay[6][0].split('-')[1] + ' / ' + weekDay[6][0].split('-')[2]} 下週課表管理</h1>
                                    <div className="row my-3 justify-content-around">
                                        <div className="col-md-2 d-flex justify-content-center align-content-between">
                                            <button className="btn btn-secondary w-100 rounded-pill">新增課程</button>
                                        </div>
                                        <div className="col-md-2 d-flex justify-content-center align-content-between">
                                        ...
                                        <div className="col-md-2 d-flex justify-content-center align-content-between">
                                            <button onClick={() => { fetchdata() }} className='w-100 btn bg-blue rounded-pill d-flex align-content-center justify-content-center'>
                                                課程搜尋
                            ...
                            {console.log(next_course)}
                            {next_course['fullname'].map((item, i) => (
                                <>
                                    <div className="row  justify-content-center">
                                        <div className="col-md-11">
                                            <div className="row border my-3 rounded-pill  item-hover p-2 py-3">
                                                <div className="col-md-2 ps-5 d-flex align-items-center">
                                                    <p className="my-2 fs-5 w-100 "> 學生 : {item}</p>

                                                </div>
                                                <div className="col-md-2 d-flex align-items-center">
                                                    <p className="my-2 fs-5 text-center w-100"> {next_course['class_title'][i]}</p>

                                                </div>
                                                <div className="col-md-2 d-flex align-items-center">
                                                    <select className="form-select w-100 my-1">
                                                        <option className="text-center">{next_course['class_time'][i].split(" ")[0]}</option>
                                                        <option></option>
                                                    </select>
                                                ...
                                                <div className="col-md-2 d-flex align-items-center">
                                                    <select className="form-select w-100 my-1">
                                                        <option className="text-center">{next_course['class_time'][i].split(" ")[1]}</option>
                                                        <option></option>
                                                    </select>
                                                ...
                                                <div className="col-md-2 d-flex align-items-center">
                                                    <select className="form-select w-100 my-1">
                                                        <option className="text-center">{next_course['finish']}</option>
                                                        <option>未完成</option>
                                                        <option>請假</option>
                                                    </select>
                                                </div>
                                                <div className="col-md-1 d-flex align-items-center">
                                                    <button className="btn btn-primary rounded-pill w-100">修改</button>
                                        
                                                </div>
                                                <div className="col-md-1 d-flex align-items-center">
                                                    <button className="btn btn-danger rounded-pill w-100">刪除</button>
